...
def balanced(m):
    ...
    """
    "*** YOUR CODE HERE ***"
    def is_balanced_structure(structure):
        if is_planet(structure):
            return True
    ...
    if left_torque == right_torque and is_balanced_structure(left_end) and is_balanced_structure(right_end):
        return True
    else:
        return False
